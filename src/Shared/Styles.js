...
export const color4 = lightTheme ? '##0909f0' : '##3a41ff';
...
export const greenBackgroundColor = `background-color: ${color4};`;
...
export const blueBoxShadow = `box-shadow: 0px 0px 4px 2px #2317ff`;
